...
export const queryListings = ({
  ...
  const orderSqlWithAlias = orderSql
    ...
    .replace(/\bnumeric_price\b/g, 'l.numeric_price')
    .replace(/\bnumeric_size\b/g, 'l.numeric_size')
    .replace(/\bprice_per_sqm\b/g, 'l.price_per_sqm')
    .replace(/\bnumeric_rooms\b/g, 'l.numeric_rooms')
    .replace(/\byear_built\b/g, 'l.year_built')
    .replace(/\baddress_full\b/g, 'l.address_full')
    .replace(/\bpublished_text\b/g, 'l.published_text')
    .replace(/\bhas_kitchen\b/g, 'l.has_kitchen')
    .replace(/\bhas_cellar\b/g, 'l.has_cellar')
    .replace(/\bhas_lift\b/g, 'l.has_lift')
    .replace(/\bis_barrier_free\b/g, 'l.is_barrier_free')
    .replace(/\bprice_indicator_percent\b/g, 'l.price_indicator_percent')
    .replace(/\bis_private\b/g, 'l.is_private')
    .replace(/\blast_refurbishment_year\b/g, 'l.last_refurbishment_year')
    .replace(/\bcondition\b/g, 'l.condition')
    .replace(/\binterior_quality\b/g, 'l.interior_quality')
    .replace(/\bflat_type\b/g, 'l.flat_type')
    .replace(/\bstreet\b/g, 'l.street')
    .replace(/\bzip_code\b/g, 'l.zip_code')
    .replace(/\bcity\b/g, 'l.city')
    .replace(/\benergy_class\b/g, 'l.energy_class')
    .replace(/\bheating_type\b/g, 'l.heating_type')
    .replace(/\benergy_source\b/g, 'l.energy_source')
    .replace(/\bservice_charge\b/g, 'l.service_charge')
    .replace(/\badditional_purchase_costs\b/g, 'l.additional_purchase_costs')
    .replace(/\bhas_balcony\b/g, 'l.has_balcony')
    .replace(/\bhas_garden\b/g, 'l.has_garden')
