...
/**
 * Extracts a number from a string by removing non-numeric characters.
 * It handles German-style decimal commas.
 * @param {string|number} text The string to parse.
 * @returns {number|null} The parsed number or null if invalid.
 */
function extractNumber(text) {
  if (text == null) return null;
  // Also handle cases where a number is passed in directly
